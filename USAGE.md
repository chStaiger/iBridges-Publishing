...
### B2SHARE
- You need an account and API token for the instnace https://trng-b2share.eudat.eu/
...
- Parameters
 ...
 #Repository credentials and parameters
 apiToken        = '******************************************'
...
- Workflows
 ...
 - [workflowPublish.py](clients/workflowPublish.py) more convenient example; uses the irodsRepositopryClient to abstract from single tasks in the publishing proccess
